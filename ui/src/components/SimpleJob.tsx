...
import {
  ...
  defaultQtype,
  jobTypeOptions,
} from '@/app/train/options';
import { defaultDatasetConfig } from '@/app/train/jobConfig';
...
import { handleModelArchChange } from '@/app/train/utils';
    ...
    <>
      <form onSubmit={handleSubmitAction} className="space-y-8">
        <div className={topBarClass}>
          <Card title="Job">
            <TextInput
              ...
              docKey="config.name"
              onChange={value => setJobConfigAction(value, 'config.name')}
            ...
            <SelectInput
              ...
              value={`${gpuIDs}`}
              docKey="gpuids"
              onChange={value => setGpuIDsAction(value)}
            ...
            {disableSections.includes('trigger_word') ? null : (
              <TextInput
                ...
                onChange={(value: string | null) => {
                  ...
                  setJobConfigAction(value, 'config.process[0].trigger_word');
                }}
                placeholder=""
                required
              />
          ...
          <Card title="Model">
            <SelectInput
              ...
              onChange={value => {
                handleModelArchChange(jobConfig.config.process[0].model.arch, value, jobConfig, setJobConfigAction);
              }}
            ...
            <TextInput
              ...
              onChange={(value: string | null) => {
                ...
                setJobConfigAction(value, 'config.process[0].model.name_or_path');
              }}
              placeholder=""
              required
            />
            {modelArch?.additionalSections?.includes('model.low_vram') && (
              <FormGroup label="Options">
                <Checkbox
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].model.low_vram')}
                />
              </FormGroup>
            )}
            {modelArch?.additionalSections?.includes('model.qie.match_target_res') && (
              <Checkbox
                ...
                onChange={value => setJobConfigAction(value, 'config.process[0].model.model_kwargs.match_target_res')}
              />
            )}
            {modelArch?.additionalSections?.includes('model.layer_offloading') && (
              <>
                <Checkbox
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].model.layer_offloading')}
                ...
                {jobConfig.config.process[0].model.layer_offloading && (
                  <div className="pt-2">
                    <SliderInput
                      ...
                      onChange={value =>
                        setJobConfigAction(value * 0.01, 'config.process[0].model.layer_offloading_transformer_percent')
                      }
                      min={0}
                      max={100}
                      step={1}
                    ...
                    <SliderInput
                      ...
                      onChange={value =>
                        setJobConfigAction(value * 0.01, 'config.process[0].model.layer_offloading_text_encoder_percent')
                      }
                      min={0}
                      max={100}
                      step={1}
          ...
          {disableSections.includes('model.quantize') ? null : (
            <Card title="Quantization">
              <SelectInput
                ...
                onChange={value => {
                  if (value === '') {
                    setJobConfigAction(false, 'config.process[0].model.quantize');
                    value = defaultQtype;
                  } else {
                    setJobConfigAction(true, 'config.process[0].model.quantize');
                  }
                  setJobConfigAction(value, 'config.process[0].model.qtype');
                }}
              ...
              <SelectInput
                ...
                onChange={value => {
                  if (value === '') {
                    setJobConfigAction(false, 'config.process[0].model.quantize_te');
                    value = defaultQtype;
                  } else {
                    setJobConfigAction(true, 'config.process[0].model.quantize_te');
                  }
                  setJobConfigAction(value, 'config.process[0].model.qtype_te');
                }}
            ...
            <Card title="Multistage">
              <FormGroup label="Stages to Train" docKey={'model.multistage'}>
                <Checkbox
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].model.model_kwargs.train_high_noise')}
                />
                <Checkbox
                  label="Low Noise"
                  checked={jobConfig.config.process[0].model.model_kwargs?.train_low_noise || false}
                  onChange={value => setJobConfigAction(value, 'config.process[0].model.model_kwargs.train_low_noise')}
                />
              </FormGroup>
              <NumberInput
                label="Switch Every"
                value={jobConfig.config.process[0].train.switch_boundary_every}
                onChange={value => setJobConfigAction(value, 'config.process[0].train.switch_boundary_every')}
                placeholder="eg. 1"
          ...
          <Card title="Target">
            <SelectInput
              ...
              onChange={value => setJobConfigAction(value, 'config.process[0].network.type')}
              options={[
            ...
            {jobConfig.config.process[0].network?.type == 'lokr' && (
              <SelectInput
                ...
                onChange={value => setJobConfigAction(parseInt(value), 'config.process[0].network.lokr_factor')}
                options={[
                  { value: '-1', label: 'Auto' },
                  { value: '4', label: '4' },
                  { value: '8', label: '8' },
              ...
              <>
                <NumberInput
                  ...
                  onChange={value => {
                    ...
                    setJobConfigAction(value, 'config.process[0].network.linear');
                    setJobConfigAction(value, 'config.process[0].network.linear_alpha');
                  }}
                  placeholder="eg. 16"
                  min={0}
                  max={1024}
                ...
                {disableSections.includes('network.conv') ? null : (
                  <NumberInput
                    ...
                    onChange={value => {
                      console.log('onChange', value);
                      setJobConfigAction(value, 'config.process[0].network.conv');
                      setJobConfigAction(value, 'config.process[0].network.conv_alpha');
                    }}
                    placeholder="eg. 16"
                    min={0}
                    max={1024}
          ...
          {!disableSections.includes('slider') && (
            <Card title="Slider">
              <TextInput
                ...
                onChange={value => setJobConfigAction(value, 'config.process[0].slider.target_class')}
              ...
              <TextInput
                ...
                onChange={value => setJobConfigAction(value, 'config.process[0].slider.positive_prompt')}
              ...
              <TextInput
                ...
                onChange={value => setJobConfigAction(value, 'config.process[0].slider.negative_prompt')}
              ...
              <TextInput
                ...
                onChange={value => setJobConfigAction(value, 'config.process[0].slider.anchor_class')}
                placeholder=""
              />
            </Card>
          )}
          <Card title="Save">
            <SelectInput
              ...
              onChange={value => setJobConfigAction(value, 'config.process[0].save.dtype')}
              options={[
            ...
            <NumberInput
              ...
              onChange={value => setJobConfigAction(value, 'config.process[0].save.save_every')}
              placeholder="eg. 250"
              min={1}
              required
            />
            <NumberInput
              ...
              onChange={value => setJobConfigAction(value, 'config.process[0].save.max_step_saves_to_keep')}
              placeholder="eg. 4"
              min={1}
              required
            />
            ...
            <div className={trainingBarClass}>
              <div>
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.batch_size')}
                  placeholder="eg. 4"
                  min={1}
                  required
                />
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.gradient_accumulation')}
                  placeholder="eg. 1"
                  min={1}
                  required
                />
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.steps')}
                  placeholder="eg. 2000"
                  min={1}
                  required
                />
              ...
              <div>
                <SelectInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.optimizer')}
                  options={[
                ...
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.lr')}
                ...
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.optimizer_params.weight_decay')}
                  placeholder="eg. 0.0001"
                  min={0}
                  required
                />
              ...
              <div>
                {disableSections.includes('train.timestep_type') ? null : (
                  <SelectInput
                    ...
                    onChange={value => setJobConfigAction(value, 'config.process[0].train.timestep_type')}
                    options={[
                ...
                <SelectInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.content_or_style')}
                  options={[
                ...
                <SelectInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].train.loss_type')}
                  options={[
              ...
              <div>
                <FormGroup label="EMA (Exponential Moving Average)">
                  <Checkbox
                    ...
                    onChange={value => setJobConfigAction(value, 'config.process[0].train.ema_config.use_ema')}
                  />
                </FormGroup>
                {jobConfig.config.process[0].train.ema_config?.use_ema && (
                  <NumberInput
                    ...
                    onChange={value => setJobConfigAction(value, 'config.process[0].train.ema_config?.ema_decay')}
                    placeholder="eg. 0.99"
                    min={0}
                  />
                )}
                ...
                <FormGroup label="Text Encoder Optimizations" className="pt-2">
                  {!disableSections.includes('train.unload_text_encoder') && (
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.unload_text_encoder');
                        if (value) {
                          setJobConfigAction(false, 'config.process[0].train.cache_text_embeddings');
                        }
                      }}
                    />
                  )}
                  <Checkbox
                    ...
                    onChange={value => {
                      setJobConfigAction(value, 'config.process[0].train.cache_text_embeddings');
                      if (value) {
                        setJobConfigAction(false, 'config.process[0].train.unload_text_encoder');
                      }
                    }}
                  />
                </FormGroup>
                ...
                {disableSections.includes('train.diff_output_preservation') ? null : (
                  <>
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.diff_output_preservation');
                        if (value && jobConfig.config.process[0].train.blank_prompt_preservation) {
                          // only one can be enabled at a time
                          setJobConfigAction(false, 'config.process[0].train.blank_prompt_preservation');
                        }
                      }}
                    />
                    {jobConfig.config.process[0].train.diff_output_preservation && (
                      <>
                        <NumberInput
                          ...
                          onChange={value =>
                            setJobConfigAction(value, 'config.process[0].train.diff_output_preservation_multiplier')
                          }
                          placeholder="eg. 1.0"
                          min={0}
                        />
                        <TextInput
                          ...
                          onChange={value =>
                            setJobConfigAction(value, 'config.process[0].train.diff_output_preservation_class')
                          }
                ...
                {disableSections.includes('train.blank_prompt_preservation') ? null : (
                  <>
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.blank_prompt_preservation');
                        if (value && jobConfig.config.process[0].train.diff_output_preservation) {
                          // only one can be enabled at a time
                          setJobConfigAction(false, 'config.process[0].train.diff_output_preservation');
                        }
                      }}
                    />
                    {jobConfig.config.process[0].train.blank_prompt_preservation && (
                      <>
                        <NumberInput
                          ...
                          onChange={value =>
                            setJobConfigAction(value, 'config.process[0].train.blank_prompt_preservation_multiplier')
                          }
                          placeholder="eg. 1.0"
                          min={0}
                        />
        ...
        <div>
          ...
          {/*          setJobConfigAction(newValue, 'config.process[0].train.do_differential_guidance');*/}
          {/*          if (!newValue) {*/}
          {/*            setJobConfigAction(undefined, 'config.process[0].train.differential_guidance_scale');*/}
          {/*          } else if (*/}
          ...
          {/*            setJobConfigAction(3.0, 'config.process[0].train.differential_guidance_scale');*/}
          {/*          }*/}
          {/*        }}*/}
          {/*      />*/}
          ...
          {/*            onChange={value => setJobConfigAction(value, 'config.process[0].train.differential_guidance_scale')}*/}
          {/*            placeholder="eg. 3.0"*/}
          {/*            min={0}*/}
          {/*          />*/}
          {/*        </>*/}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div>
                      <SelectInput
                        ...
                        onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].folder_path`)}
                      ...
                      {modelArch?.additionalSections?.includes('datasets.control_path') && (
                        <SelectInput
                          ...
                          className="pt-2"
                          onChange={value =>
                            setJobConfigAction(value == '' ? null : value, `config.process[0].datasets[${i}].control_path`)
                          }
                      ...
                      <NumberInput
                        ...
                        className="pt-2"
                        onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].network_weight`)}
                        placeholder="eg. 1.0"
                      />
                    </div>
                    <div>
                      ...
                      <NumberInput
                        ...
                        onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].caption_dropout_rate`)}
                        placeholder="eg. 0.05"
                        min={0}
                        required
                      />
                      {modelArch?.additionalSections?.includes('datasets.num_frames') && (
                        <NumberInput
                          ...
                          onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].num_frames`)}
                          placeholder="eg. 41"
                          min={1}
                          required
                        />
                    ...
                    <div>
                      <FormGroup label="Settings" className="">
                        <Checkbox
                          ...
                          onChange={value =>
                            setJobConfigAction(value, `config.process[0].datasets[${i}].cache_latents_to_disk`)
                          }
                        />
                        <Checkbox
                          label="Is Regularization"
                          checked={dataset.is_reg || false}
                          onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].is_reg`)}
                        />
                        {modelArch?.additionalSections?.includes('datasets.do_i2v') && (
                          <Checkbox
                            label="Do I2V"
                            checked={dataset.do_i2v || false}
                            onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].do_i2v`)}
                      ...
                      <FormGroup label="Flipping" docKey={'datasets.flip'} className="mt-2">
                        <Checkbox
                          ...
                          onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].flip_x`)}
                        />
                        <Checkbox
                          label={
                            <>
                          ...
                          onChange={value => setJobConfigAction(value, `config.process[0].datasets[${i}].flip_y`)}
                        />
                      </FormGroup>
                    </div>
                    <div>
                              ...
                              {resGroup.map(res => (
                                <Checkbox
                                  ...
                                  onChange={() => {
                                    ...
                                    setJobConfigAction(resolutions, `config.process[0].datasets[${i}].resolution`);
                                  }}
                                />
                              ))}
                            </div>
            ...
            >
              <div>
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.sample_every')}
                  placeholder="eg. 250"
                  min={1}
                  required
                />
                <SelectInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.sampler')}
                  options={[
                ...
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.guidance_scale')}
                  placeholder="eg. 1.0"
                  className="pt-2"
                  min={0}
                  required
                ...
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.sample_steps')}
                  placeholder="eg. 1"
                  className="pt-2"
                  min={1}
                  required
              ...
              <div>
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.width')}
                  placeholder="eg. 1024"
                  min={0}
                  required
                />
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.height')}
                  placeholder="eg. 1024"
                  className="pt-2"
                  min={0}
                  required
                ...
                {isVideoModel && (
                  <div>
                    <NumberInput
                      ...
                      onChange={value => setJobConfigAction(value, 'config.process[0].sample.num_frames')}
                      placeholder="eg. 0"
                      className="pt-2"
                      min={0}
                      required
                    ...
                    <NumberInput
                      ...
                      onChange={value => setJobConfigAction(value, 'config.process[0].sample.fps')}
                      placeholder="eg. 0"
                      className="pt-2"
                      min={0}
                      required
              ...
              <div>
                <NumberInput
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.seed')}
                  placeholder="eg. 0"
                  min={0}
                  required
                />
                <Checkbox
                  ...
                  onChange={value => setJobConfigAction(value, 'config.process[0].sample.walk_seed')}
                />
              </div>
              <div>
                <FormGroup label="Advanced Sampling" className="pt-2">
                  <div>
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.skip_first_sample');
                        // cannot do both, so disable the other
                        if (value) {
                          setJobConfigAction(false, 'config.process[0].train.force_first_sample');
                        }
                      }}
                    />
                  </div>
                  <div>
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.force_first_sample');
                        // cannot do both, so disable the other
                        if (value) {
                          setJobConfigAction(false, 'config.process[0].train.skip_first_sample');
                        }
                      }}
                    />
                  </div>
                  <div>
                    <Checkbox
                      ...
                      onChange={value => {
                        setJobConfigAction(value, 'config.process[0].train.disable_sampling');
                        // cannot do both, so disable the other
                        if (value) {
                          setJobConfigAction(false, 'config.process[0].train.force_first_sample');
                        }
                    ...
                    <div className="flex">
                      <div className="flex-1">
                        <TextInput
                          label={`Prompt`}
                          value={sample.prompt}
                          onChange={value => setJobConfigAction(value, `config.process[0].sample.samples[${i}].prompt`)}
                          ...
                          <TextInput
                            ...
                            onChange={value => {
                              ...
                              if (value === '') {
                                ...
                                if (!isNaN(intValue)) {
                                  setJobConfigAction(intValue, `config.process[0].sample.samples[${i}].width`);
                                } else {
                          ...
                          <TextInput
                            ...
                            onChange={value => {
                              ...
                              if (value === '') {
                                ...
                                const intValue = parseInt(value);
                                if (!isNaN(intValue)) {
                                  setJobConfigAction(intValue, `config.process[0].sample.samples[${i}].height`);
                                } else {
                          ...
                          <TextInput
                            ...
                            onChange={value => {
                              ...
                              if (value === '') {
                                ...
                                const intValue = parseInt(value);
                                if (!isNaN(intValue)) {
                                  setJobConfigAction(intValue, `config.process[0].sample.samples[${i}].seed`);
                                } else {
                          ...
                          <TextInput
                            ...
                            onChange={value => {
                              ...
                              if (value === '') {
                                ...
                                // set it as a string
                                setJobConfigAction(value, `config.process[0].sample.samples[${i}].network_multiplier`);
                                return;
                              }
                            }}
                              ...
                              <SampleControlImage
                                ...
                                onNewImageSelected={imagePath => {
                                  if (!imagePath) {
                                    ...
                                    setJobConfigAction(imagePath, `config.process[0].sample.samples[${i}].${ctrlKey}`);
                                  }
                                }}
                              />
                            ))}
                        ...
                        <SampleControlImage
                          ...
                          onNewImageSelected={imagePath => {
                            if (!imagePath) {
                              ...
                              setJobConfigAction(imagePath, `config.process[0].sample.samples[${i}].ctrl_img`);
                            }
                          }}
                        />
                      )}
